...
-- --         -- print("Subunit: " .. k)
-- --         -- PrintTable(subunit)
-- --         PD.List.Tbl[subunit.unit].subunits[subunit.name] = {
-- --             name = subunit.name,
-- --             unit = subunit.unit,
-- --             jobs = {},
-- --             color = subunit.color,
...
-- --         }
-- --     end
-- --     print("Subunits geladen.")
-- --     local rank = 0
-- --     for k, job in SortedPairs(alljobs) do
-- --         local subunuitName, subunitTable = PD.JOBS.GetSubUnit(job.unit)

-- --         -- Wenn subunit ändert wird rank zurückgesetzt
-- --         if subunitTable.unit != job.unit then
-- --             rank = 0
-- --         end

-- --         -- print("Job: " .. k .. " - " .. subunuitName .. " - " .. subunitTable.unit)

-- --         PD.List.Tbl[subunitTable.unit].subunits[job.unit].jobs[job.name] = {
-- --             name = job.name,
-- --             players = {},
-- --             color = job.color,
-- --             default = job.default,
